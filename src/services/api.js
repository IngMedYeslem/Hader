...
console.log('Base URL pour médias:', Platform.OS !== 'web' ? 'http://172.20.10.8:3000' : 'http://localhost:3000');
...
export const getMediaUrl = (mediaPath) => {
  ...
  if (mediaPath.startsWith('http')) {
    if (Platform.OS !== 'web' && mediaPath.includes('localhost')) {
      const correctedUrl = mediaPath.replace('localhost', '172.20.10.8');
  ...
  const baseUrl = Platform.OS !== 'web' ? 'http://172.20.10.8:3000' : 'http://localhost:3000';
