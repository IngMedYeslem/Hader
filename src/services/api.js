...
console.log('Base URL pour médias:', Platform.OS !== 'web' ? 'http://192.168.0.110:3000' : 'http://localhost:3000');
...
export const getMediaUrl = (mediaPath) => {
  ...
  if (mediaPath.startsWith('http')) {
    if (Platform.OS !== 'web' && mediaPath.includes('localhost')) {
      const correctedUrl = mediaPath.replace('localhost', '192.168.0.110');
  ...
  const baseUrl = Platform.OS !== 'web' ? 'http://192.168.0.110:3000' : 'http://localhost:3000';
