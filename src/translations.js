...
const translations = {
  fr: {
    ...
    electronics: 'Électronique & Appareils',
    home: 'Meubles & Maison',
    pharmacy: 'Santé & Médicaments',
    beauty: 'Beauté & Soins personnels',
    sports: 'Sport & Fitness',
    books: 'Livres & Papeterie',
    toys: 'Jouets & Jeux',
    automotive: 'Auto & Pièces détachées',
    pets: 'Animaux & Accessoires',
  ...
  ar: {
    ...
    pets: 'حيوانات أليفة ومستلزماتها',
